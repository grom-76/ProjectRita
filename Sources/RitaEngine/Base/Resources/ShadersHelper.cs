...
using System.IO;
using RitaEngine.Base.Resources.Shader.ShaderCompiler;
using RitaEngine.Base.Resources.Shader.SpirvCross;
...
public static  class Shaders
{
    public static void CreateSPIRV(string path, string input, string output, ShaderType shadertype, string entrypoint)
    {
        ...
        using RitaEngine.Base.Resources.Shader.ShaderCompiler.Compiler compiler = new (path);
    ...
    public static void ShaderCrossCompiler(string path,string filename,  Backend format)
    {
        ...
        try
        {
            ...
            using RitaEngine.Base.Resources.Shader.SpirvCross.Context context = new();
            context.ParseSpirv(vertexBytecode, out SpvcParsedIr parsedIr).CheckResult();
            RitaEngine.Base.Resources.Shader.SpirvCross.Compiler compiler = context.CreateCompiler(format, parsedIr, CaptureMode.TakeOwnership);
