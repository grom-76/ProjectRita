...
/// <summary> Spécifier la façon dont un composant est modifié </summary>
[Flags]public enum VkComponentSwizzle :uint{
    /// <summary>specifies that the component is set to the identity swizzle. </summary>
...
public enum VkCommandBufferResetFlagBits {
    ...
    VK_COMMAND_BUFFER_RESET_RELEASE_NONE =0x00000000
}
...
public enum VkPerformanceCounterUnitKHR {
    ...
    VK_PERFORMANCE_COUNTER_UNIT_ConstCharS_KHR = 3,
    VK_PERFORMANCE_COUNTER_UNIT_ConstCharS_PER_SECOND_KHR = 4,
