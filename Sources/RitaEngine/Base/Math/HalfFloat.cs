...
/// <summary>
/// Represents a half-precision floating point number. Code From GLM
/// </summary>
/// <remarks>
/// Note:
...
public struct Half : IComparable, IFormattable, IConvertible, IComparable<Half>, IEquatable<Half>
{
    ...
    public Half(float value) { this = SingleToHalf(value); }
    /// <summary>
    ...
    public static Half operator -(Half half) { return Negate(half); }
    /// <summary>
    ...
    public static implicit operator float(Half value) { return (float)HalfToSingle(value); }
    /// <summary>
    ...
    // /// <summary>
    // /// Converts a System.Half to a System.Complex.
    // /// </summary>
    // /// <param name="value">A System.Half to convert.</param>
    // /// <returns>A System.Complex that represents the converted System.Half with zero imaginary part.</returns>
    // public static explicit operator Complex (Half value) { return (Complex)(float)value; }
    /// <summary>
    ...
    /// </summary>
    /// <param name="half">A number in the range System.Half.MinValue ≤ value ≤ System.Half.MaxValue.</param>
