...
public struct VulkanFunctions : IEquatable<VulkanFunctions>
{
    ...
    public unsafe void* vkGetInstanceProcAddr(VkInstance instance, string name)
    {
        ...
        {
			result =  Loader.FuncvkGetInstanceProcAddr(  instance,ptr );
		}
        return result;
    }
    ...
    public unsafe void* vkGetDeviceProcAddr(VkDevice device, string name)
    {
		...
		byte[] bytes = Encoding.ASCII.GetBytes(name);
		fixed( byte* ptr = bytes){
			result =  Loader.FuncvkGetDeviceProcAddr(  device,ptr );
		}
        return result;
    }
    public VulkanFunctionsLoader Loader;
    public VulkanFunctionInstances Instance;
    public VulkanFunctionDevices Device;

    #region OVERRIDE
    public override string ToString() => string.Format($"Graphic Device Functions" );
    public unsafe override int GetHashCode() => HashCode.Combine( Loader , Instance, Device ) ;
    public override bool Equals(object? obj) => obj is VulkanFunctions context && this.Equals(context) ;
    public unsafe bool Equals(VulkanFunctions other)=> other is VulkanFunctions vulkan &&  Loader.Equals(other.Loader) ;
    public static bool operator ==(VulkanFunctions  left, VulkanFunctions right) => left.Equals(right);
    public static bool operator !=(VulkanFunctions  left, VulkanFunctions  right) => !left.Equals(right);
    #endregion
...
[SkipLocalsInit, StructLayout(LayoutKind.Sequential ,Pack =  BaseHelper.FORCE_ALIGNEMENT)]
public unsafe struct VulkanFunctionsLoader : IEquatable<VulkanFunctionsLoader>
{
    ...
    public VulkanFunctionsLoader( string VulkandllName) 
    {
    ...
    public void Dispose()  { Libraries.Unload(vulkan);  } 

	#region OVERRIDE    
    public override string ToString() => string.Format($"Graphic Device Functions" );
    public override int GetHashCode() => (int)0;
    public override bool Equals(object? obj) => obj is VulkanFunctionsLoader loader && this.Equals(loader) ;
    public bool Equals(VulkanFunctionsLoader other)=> vulkan.Equals( other.vulkan) ;
    public static bool operator ==(VulkanFunctionsLoader left, VulkanFunctionsLoader right) => left.Equals(right);
    public static bool operator !=(VulkanFunctionsLoader left, VulkanFunctionsLoader  right) => !left.Equals(right);
    #endregion
}

[SkipLocalsInit, StructLayout(LayoutKind.Sequential ,Pack =  BaseHelper.FORCE_ALIGNEMENT)]
public unsafe struct VulkanFunctionInstances : IEquatable<VulkanFunctionInstances>
{
...
// typedef VkResult (VKAPI_PTR *PFN_vkGetWinrtDisplayNV)(VkPhysicalDevice physicalDevice, uint32_t deviceRelativeId, VkDisplayKHR* pDisplay);
    ...
    public VulkanFunctionInstances( VulkanFunctions.PFN_vkGetInstanceProcAddr load , VkInstance instance)
    {
    ...
    public override string ToString() => string.Format($"Graphic Device Functions Instances" );
    public unsafe override int GetHashCode() => HashCode.Combine( ((nint)vkCreateWin32SurfaceKHR).ToInt32()  ,  ((nint)vkCreateDevice).ToInt32() ) ;
    public override bool Equals(object? obj) => obj is VulkanFunctionInstances context && this.Equals(context) ;
    public unsafe bool Equals(VulkanFunctionInstances other)=> other is VulkanFunctionInstances input ;
    public static bool operator ==(VulkanFunctionInstances  left, VulkanFunctionInstances right) => left.Equals(right);
    public static bool operator !=(VulkanFunctionInstances  left, VulkanFunctionInstances  right) => !left.Equals(right);
    #endregion
}

[SkipLocalsInit, StructLayout(LayoutKind.Sequential ,Pack =  BaseHelper.FORCE_ALIGNEMENT)]
public unsafe  struct VulkanFunctionDevices : IEquatable<VulkanFunctionDevices>
{
    ...
    public VulkanFunctionDevices( VulkanFunctions.PFN_vkGetDeviceProcAddr load , VkDevice device )
    { 
        if (VK.VK_KHR_win32_surface )
        {
    ...
    public void Dispose()  {}
	 #region OVERRIDE
    // public unsafe nint AddressOfPtrThis( ){fixed (void* pointer = &this)  { return((nint) pointer ) ; }  }
    public override string ToString() => string.Format($"Graphic Device Function Devices" );
    public unsafe override int GetHashCode() => HashCode.Combine( ((nint)0).ToInt32()  ,  ((nint)0).ToInt32(),  ((nint)0).ToInt32(), ((nint)0).ToInt32() ) ;
    public override bool Equals(object? obj) => obj is VulkanFunctionDevices context && this.Equals(context) ;
    public unsafe bool Equals(VulkanFunctionDevices other)=> other is VulkanFunctionDevices devices ;
    public static bool operator ==(VulkanFunctionDevices  left, VulkanFunctionDevices right) => left.Equals(right);
    public static bool operator !=(VulkanFunctionDevices  left, VulkanFunctionDevices  right) => !left.Equals(right);
    #endregion
}
